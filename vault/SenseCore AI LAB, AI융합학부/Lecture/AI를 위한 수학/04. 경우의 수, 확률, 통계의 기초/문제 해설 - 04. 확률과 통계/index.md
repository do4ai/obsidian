...
# 사용법
- 문제를 다시 풀기 전에 `전체 기준`, `관심 대상`, `정의`를 먼저 적어 봅니다.
- 계산보다 순서를 먼저 확인합니다.
